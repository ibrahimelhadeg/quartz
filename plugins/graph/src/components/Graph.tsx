...
export interface D3Config {
  ...
  /** Fork: keep every node label visible without hover/zoom (local graph). */
  showLabels?: boolean;
    ...
    return (
      <div class={classNames(displayClass, "graph")}>
        ...
        <div class="graph-outer">
          ...
          {localGraph.legend && (
            <ul class="graph-legend" aria-label="Edge relationship legend">
              <li class="graph-legend-outgoing">Links to</li>
              <li class="graph-legend-incoming">Linked from</li>
              <li class="graph-legend-tag">Shared tag</li>
            </ul>
          )}
